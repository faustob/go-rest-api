...
func main() {
	// Initialise & globally register the OpenTelemetry SDK (endpoint from OTEL_EXPORTER_OTLP_ENDPOINT)
	...
	// OpenTelemetry HTTP server metrics & spans, placed before auth so rejections are also counted
